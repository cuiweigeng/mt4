...
%% train Wavelet
train_o = wden(train_o, tptr, sorh, scal, lev, wname) * 100000; 
train_h = wden(train_h, tptr, sorh, scal, lev, wname) * 100000; 
train_l = wden(train_l, tptr, sorh, scal, lev, wname) * 100000; 
train_c = wden(train_c, tptr, sorh, scal, lev, wname) * 100000; 

%% test Wavelet
test_o = wden(test_o, tptr, sorh, scal, lev, wname) * 100000; 
test_h = wden(test_h, tptr, sorh, scal, lev, wname) * 100000; 
test_l = wden(test_l, tptr, sorh, scal, lev, wname) * 100000; 
test_c = wden(test_c, tptr, sorh, scal, lev, wname) * 100000; 

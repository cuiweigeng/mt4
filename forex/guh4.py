...
mnist = read_data("/Users/Administrator/Documents/MATLAB/", one_hot=True) 
...
with tf.Session() as sess:
    ...
    test_len = 5900
    test_data = mnist.test.images[:test_len-1].reshape((-1, n_steps, n_input))
    test_label = mnist.test.labels[:test_len-1]
